...
# Kill any previous uvicorn instances on lab ports
fuser -k 9000/tcp 8080/tcp 8081/tcp 8082/tcp 8083/tcp 8084/tcp 2>/dev/null || true

echo "Starting Range Manager Dashboard (Port 9000)..."
PYTHONPATH=manager/app python3 -m uvicorn main:app --host 0.0.0.0 --port 9000 --app-dir manager/app > /tmp/manager.log 2>&1 &
