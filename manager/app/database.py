...
def init_db():
    ...
    initial_labs = [
        ...
        ("snmp", "📡 Dadiwoo SNMP Network Management Lab", "Network", "SNMP v1/v2c/v3 network management server for MIB walking, community string brute forcing, OID SET exploits, and VACM defense.", 8087, 8087, "snmp.lab", "beginner", "cybersecurity", "snmp, network, mib, vacuum, brute-force, security", "stopped", "snmp-lab-container"),
        ("ssh", "🔑 Dadiwoo SSH Hacking & Defense Lab", "Network", "Interactive SSH server (TCP 2222) for Hydra password cracking, weak RSA key auth, privilege escalation, and fail2ban rate limiting.", 8088, 8088, "ssh.lab", "beginner", "cybersecurity", "ssh, network, hydra, brute-force, fail2ban, privesc", "stopped", "ssh-lab-container"),
        ("apiwarehouse", "🏬 Dadiwoo API Warehouse Lab", "API / Cloud", "Comprehensive API hacking environment covering API Keys, Bearer JWT tokens, IDOR/BOLA, GraphQL, Mass Assignment, Webhook SSRF, HMAC, and Postman testing.", 8089, 8089, "apiwarehouse.lab", "beginner", "cybersecurity", "api, postman, jwt, bearer-token, api-key, rate-limit, idor, graphql, oauth, secure", "stopped", "apiwarehouse-lab-container"),
        ("ipv6shark", "🦈 Dadiwoo IPv6 Shark / IPv6 Network Lab", "Network / IPv6", "One-page portfolio and blog microservice running on IPv6/dual-stack for learning IPv6 red team attacks (SLAAC, NDP spoofing, fragmentation) and blue team defenses.", 8090, 8090, "ipv6.lab", "beginner", "cybersecurity", "ipv6, network, redteam, blueteam, dual-stack, blog, portfolio", "stopped", "ipv6shark-lab-container")
    ]
